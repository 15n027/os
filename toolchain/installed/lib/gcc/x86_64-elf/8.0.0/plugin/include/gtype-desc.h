...
#define gt_ggc_m_15lang_identifier(X) do { \
  if (X != NULL) gt_ggc_mx_lang_identifier (X);\
  } while (0)
extern void gt_ggc_mx_lang_identifier (void *);
...
#define gt_ggc_m_31hash_map_lang_identifier__tree_(X) do { \
  if (X != NULL) gt_ggc_mx_hash_map_lang_identifier__tree_ (X);\
  } while (0)
extern void gt_ggc_mx_hash_map_lang_identifier__tree_ (void *);
...
#define gt_pch_n_15lang_identifier(X) do { \
  if (X != NULL) gt_pch_nx_lang_identifier (X);\
  } while (0)
extern void gt_pch_nx_lang_identifier (void *);
...
#define gt_pch_n_31hash_map_lang_identifier__tree_(X) do { \
  if (X != NULL) gt_pch_nx_hash_map_lang_identifier__tree_ (X);\
  } while (0)
extern void gt_pch_nx_hash_map_lang_identifier__tree_ (void *);
...
extern void gt_pch_p_27hash_table_pad_type_hasher_
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_15lang_identifier
    (void *, void *, gt_pointer_operator, void *);
...
extern void gt_pch_p_22vec_tree_pair_s_va_gc_
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_31hash_map_lang_identifier__tree_
    (void *, void *, gt_pointer_operator, void *);
