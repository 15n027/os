...
#define OPTION_MASK_ISA_AVX512BW (HOST_WIDE_INT_1U << 10)
#define OPTION_MASK_ISA_AVX512CD (HOST_WIDE_INT_1U << 11)
#define OPTION_MASK_ISA_AVX512DQ (HOST_WIDE_INT_1U << 12)
#define OPTION_MASK_ISA_AVX512ER (HOST_WIDE_INT_1U << 13)
#define OPTION_MASK_ISA_AVX512F (HOST_WIDE_INT_1U << 14)
#define OPTION_MASK_ISA_AVX512IFMA (HOST_WIDE_INT_1U << 15)
#define OPTION_MASK_ISA_AVX512PF (HOST_WIDE_INT_1U << 16)
#define OPTION_MASK_ISA_AVX512VBMI (HOST_WIDE_INT_1U << 17)
#define OPTION_MASK_ISA_AVX512VL (HOST_WIDE_INT_1U << 18)
#define OPTION_MASK_ISA_AVX512VPOPCNTDQ (HOST_WIDE_INT_1U << 2)
#define OPTION_MASK_ISA_BMI (HOST_WIDE_INT_1U << 19)
#define OPTION_MASK_ISA_BMI2 (HOST_WIDE_INT_1U << 20)
#define MASK_CALL_MS2SYSV_XLOGUES (1U << 8)
#define MASK_CLD (1U << 9)
#define OPTION_MASK_ISA_CLFLUSHOPT (HOST_WIDE_INT_1U << 21)
#define OPTION_MASK_ISA_CLWB (HOST_WIDE_INT_1U << 22)
#define OPTION_MASK_ISA_CLZERO (HOST_WIDE_INT_1U << 23)
#define OPTION_MASK_ISA_CRC32 (HOST_WIDE_INT_1U << 24)
#define OPTION_MASK_ISA_CX16 (HOST_WIDE_INT_1U << 25)
...
#define OPTION_MASK_ISA_HLE (HOST_WIDE_INT_1U << 31)
...
#define OPTION_MASK_ISA_MOVBE (HOST_WIDE_INT_1U << 35)
#define OPTION_MASK_ISA_MPX (HOST_WIDE_INT_1U << 36)
#define MASK_MS_BITFIELD_LAYOUT (1U << 18)
#define OPTION_MASK_ISA_MWAITX (HOST_WIDE_INT_1U << 37)
...
#define OPTION_MASK_ISA_SGX (HOST_WIDE_INT_1U << 4)
...
#define OPTION_MASK_ABI_X32 (HOST_WIDE_INT_1U << 56)
#define OPTION_MASK_ISA_XOP (HOST_WIDE_INT_1U << 57)
#define OPTION_MASK_ISA_XSAVE (HOST_WIDE_INT_1U << 58)
#define OPTION_MASK_ISA_XSAVEC (HOST_WIDE_INT_1U << 59)
#define OPTION_MASK_ISA_XSAVEOPT (HOST_WIDE_INT_1U << 60)
#define OPTION_MASK_ISA_XSAVES (HOST_WIDE_INT_1U << 61)
...
#define TARGET_ISA_AVX512VPOPCNTDQ ((ix86_isa_flags2 & OPTION_MASK_ISA_AVX512VPOPCNTDQ) != 0)
#define TARGET_ISA_AVX512VPOPCNTDQ_P(ix86_isa_flags2) (((ix86_isa_flags2) & OPTION_MASK_ISA_AVX512VPOPCNTDQ) != 0)
...
enum opt_code
{
  ...
  /* OPT_Wcatch_value = 185, */              /* -Wcatch-value */
  OPT_Wcatch_value_ = 186,                   /* -Wcatch-value= */
  OPT_Wchar_subscripts = 187,                /* -Wchar-subscripts */
  OPT_Wcharacter_truncation = 188,           /* -Wcharacter-truncation */
  OPT_Wchkp = 189,                           /* -Wchkp */
  OPT_Wclass_memaccess = 190,                /* -Wclass-memaccess */
  ...
  OPT_Wextra_semi = 227,                     /* -Wextra-semi */
  OPT_Wfatal_errors = 228,                   /* -Wfatal-errors */
  ...
  /* OPT_Wformat_overflow = 235, */          /* -Wformat-overflow */
  OPT_Wformat_overflow_ = 236,               /* -Wformat-overflow= */
  OPT_Wformat_security = 237,                /* -Wformat-security */
  OPT_Wformat_signedness = 238,              /* -Wformat-signedness */
  /* OPT_Wformat_truncation = 239, */        /* -Wformat-truncation */
  OPT_Wformat_truncation_ = 240,             /* -Wformat-truncation= */
  OPT_Wformat_y2k = 241,                     /* -Wformat-y2k */
  OPT_Wformat_zero_length = 242,             /* -Wformat-zero-length */
  OPT_Wformat_ = 243,                        /* -Wformat= */
  OPT_Wframe_address = 244,                  /* -Wframe-address */
  OPT_Wframe_larger_than_ = 245,             /* -Wframe-larger-than= */
  OPT_Wfree_nonheap_object = 246,            /* -Wfree-nonheap-object */
  OPT_Wfunction_elimination = 247,           /* -Wfunction-elimination */
  OPT_Whsa = 248,                            /* -Whsa */
  OPT_Wignored_attributes = 249,             /* -Wignored-attributes */
  OPT_Wignored_qualifiers = 250,             /* -Wignored-qualifiers */
  OPT_Wimplicit = 251,                       /* -Wimplicit */
  /* OPT_Wimplicit_fallthrough = 252, */     /* -Wimplicit-fallthrough */
  OPT_Wimplicit_fallthrough_ = 253,          /* -Wimplicit-fallthrough= */
  OPT_Wimplicit_function_declaration = 254,  /* -Wimplicit-function-declaration */
  OPT_Wimplicit_int = 255,                   /* -Wimplicit-int */
  OPT_Wimplicit_interface = 256,             /* -Wimplicit-interface */
  OPT_Wimplicit_procedure = 257,             /* -Wimplicit-procedure */
  /* OPT_Wimport = 258, */                   /* -Wimport */
  OPT_Wincompatible_pointer_types = 259,     /* -Wincompatible-pointer-types */
  OPT_Winherited_variadic_ctor = 260,        /* -Winherited-variadic-ctor */
  OPT_Winit_self = 261,                      /* -Winit-self */
  OPT_Winline = 262,                         /* -Winline */
  OPT_Wint_conversion = 263,                 /* -Wint-conversion */
  OPT_Wint_in_bool_context = 264,            /* -Wint-in-bool-context */
  OPT_Wint_to_pointer_cast = 265,            /* -Wint-to-pointer-cast */
  OPT_Winteger_division = 266,               /* -Winteger-division */
  OPT_Wintrinsic_shadow = 267,               /* -Wintrinsic-shadow */
  OPT_Wintrinsics_std = 268,                 /* -Wintrinsics-std */
  OPT_Winvalid_memory_model = 269,           /* -Winvalid-memory-model */
  OPT_Winvalid_offsetof = 270,               /* -Winvalid-offsetof */
  OPT_Winvalid_pch = 271,                    /* -Winvalid-pch */
  OPT_Wjump_misses_init = 272,               /* -Wjump-misses-init */
  OPT_Wl_ = 273,                             /* -Wl, */
  /* OPT_Wlarger_than_ = 274, */             /* -Wlarger-than- */
  OPT_Wlarger_than_ = 275,                   /* -Wlarger-than= */
  OPT_Wline_truncation = 276,                /* -Wline-truncation */
  OPT_Wliteral_suffix = 277,                 /* -Wliteral-suffix */
  OPT_Wlogical_not_parentheses = 278,        /* -Wlogical-not-parentheses */
  OPT_Wlogical_op = 279,                     /* -Wlogical-op */
  OPT_Wlong_long = 280,                      /* -Wlong-long */
  OPT_Wlto_type_mismatch = 281,              /* -Wlto-type-mismatch */
  OPT_Wmain = 282,                           /* -Wmain */
  OPT_Wmaybe_uninitialized = 283,            /* -Wmaybe-uninitialized */
  OPT_Wmemset_elt_size = 284,                /* -Wmemset-elt-size */
  OPT_Wmemset_transposed_args = 285,         /* -Wmemset-transposed-args */
  OPT_Wmisleading_indentation = 286,         /* -Wmisleading-indentation */
  OPT_Wmissing_braces = 287,                 /* -Wmissing-braces */
  OPT_Wmissing_declarations = 288,           /* -Wmissing-declarations */
  OPT_Wmissing_field_initializers = 289,     /* -Wmissing-field-initializers */
  /* OPT_Wmissing_format_attribute = 290, */ /* -Wmissing-format-attribute */
  OPT_Wmissing_include_dirs = 291,           /* -Wmissing-include-dirs */
  /* OPT_Wmissing_noreturn = 292, */         /* -Wmissing-noreturn */
  OPT_Wmissing_parameter_type = 293,         /* -Wmissing-parameter-type */
  OPT_Wmissing_prototypes = 294,             /* -Wmissing-prototypes */
  /* OPT_Wmudflap = 295, */                  /* -Wmudflap */
  OPT_Wmultichar = 296,                      /* -Wmultichar */
  OPT_Wmultiple_inheritance = 297,           /* -Wmultiple-inheritance */
  OPT_Wmultistatement_macros = 298,          /* -Wmultistatement-macros */
  OPT_Wnamespaces = 299,                     /* -Wnamespaces */
  OPT_Wnarrowing = 300,                      /* -Wnarrowing */
  OPT_Wnested_externs = 301,                 /* -Wnested-externs */
  OPT_Wnoexcept = 302,                       /* -Wnoexcept */
  OPT_Wnoexcept_type = 303,                  /* -Wnoexcept-type */
  OPT_Wnon_template_friend = 304,            /* -Wnon-template-friend */
  OPT_Wnon_virtual_dtor = 305,               /* -Wnon-virtual-dtor */
  OPT_Wnonnull = 306,                        /* -Wnonnull */
  OPT_Wnonnull_compare = 307,                /* -Wnonnull-compare */
  /* OPT_Wnormalized = 308, */               /* -Wnormalized */
  OPT_Wnormalized_ = 309,                    /* -Wnormalized= */
  OPT_Wnull_dereference = 310,               /* -Wnull-dereference */
  OPT_Wodr = 311,                            /* -Wodr */
  ...
  OPT_Woverflow = 316,                       /* -Woverflow */
  OPT_Woverlength_strings = 317,             /* -Woverlength-strings */
  OPT_Woverloaded_virtual = 318,             /* -Woverloaded-virtual */
  OPT_Woverride_init = 319,                  /* -Woverride-init */
  OPT_Woverride_init_side_effects = 320,     /* -Woverride-init-side-effects */
  OPT_Wp_ = 321,                             /* -Wp, */
  OPT_Wpacked = 322,                         /* -Wpacked */
  OPT_Wpacked_bitfield_compat = 323,         /* -Wpacked-bitfield-compat */
  OPT_Wpadded = 324,                         /* -Wpadded */
  OPT_Wparentheses = 325,                    /* -Wparentheses */
  OPT_Wpedantic = 326,                       /* -Wpedantic */
  /* OPT_Wplacement_new = 327, */            /* -Wplacement-new */
  OPT_Wplacement_new_ = 328,                 /* -Wplacement-new= */
  OPT_Wpmf_conversions = 329,                /* -Wpmf-conversions */
  OPT_Wpointer_arith = 330,                  /* -Wpointer-arith */
  OPT_Wpointer_compare = 331,                /* -Wpointer-compare */
  ...
  OPT_Wreal_q_constant = 338,                /* -Wreal-q-constant */
  OPT_Wrealloc_lhs = 339,                    /* -Wrealloc-lhs */
  OPT_Wrealloc_lhs_all = 340,                /* -Wrealloc-lhs-all */
  OPT_Wredundant_decls = 341,                /* -Wredundant-decls */
  OPT_Wregister = 342,                       /* -Wregister */
  OPT_Wreorder = 343,                        /* -Wreorder */
  OPT_Wrestrict = 344,                       /* -Wrestrict */
  OPT_Wreturn_local_addr = 345,              /* -Wreturn-local-addr */
  OPT_Wreturn_type = 346,                    /* -Wreturn-type */
  OPT_Wscalar_storage_order = 347,           /* -Wscalar-storage-order */
  ...
  OPT_Wshadow_compatible_local = 354,        /* -Wshadow=compatible-local */
  /* OPT_Wshadow_global = 355, */            /* -Wshadow=global */
  OPT_Wshadow_local = 356,                   /* -Wshadow=local */
  OPT_Wshift_count_negative = 357,           /* -Wshift-count-negative */
  OPT_Wshift_count_overflow = 358,           /* -Wshift-count-overflow */
  OPT_Wshift_negative_value = 359,           /* -Wshift-negative-value */
  /* OPT_Wshift_overflow = 360, */           /* -Wshift-overflow */
  OPT_Wshift_overflow_ = 361,                /* -Wshift-overflow= */
  OPT_Wsign_compare = 362,                   /* -Wsign-compare */
  OPT_Wsign_conversion = 363,                /* -Wsign-conversion */
  OPT_Wsign_promo = 364,                     /* -Wsign-promo */
  OPT_Wsized_deallocation = 365,             /* -Wsized-deallocation */
  OPT_Wsizeof_array_argument = 366,          /* -Wsizeof-array-argument */
  OPT_Wsizeof_pointer_div = 367,             /* -Wsizeof-pointer-div */
  OPT_Wsizeof_pointer_memaccess = 368,       /* -Wsizeof-pointer-memaccess */
  OPT_Wstack_protector = 369,                /* -Wstack-protector */
  OPT_Wstack_usage_ = 370,                   /* -Wstack-usage= */
  OPT_Wstrict_aliasing = 371,                /* -Wstrict-aliasing */
  OPT_Wstrict_aliasing_ = 372,               /* -Wstrict-aliasing= */
  OPT_Wstrict_null_sentinel = 373,           /* -Wstrict-null-sentinel */
  OPT_Wstrict_overflow = 374,                /* -Wstrict-overflow */
  OPT_Wstrict_overflow_ = 375,               /* -Wstrict-overflow= */
  OPT_Wstrict_prototypes = 376,              /* -Wstrict-prototypes */
  OPT_Wstrict_selector_match = 377,          /* -Wstrict-selector-match */
  /* OPT_Wstringop_overflow = 378, */        /* -Wstringop-overflow */
  OPT_Wstringop_overflow_ = 379,             /* -Wstringop-overflow= */
  OPT_Wsubobject_linkage = 380,              /* -Wsubobject-linkage */
  OPT_Wsuggest_attribute_const = 381,        /* -Wsuggest-attribute=const */
  OPT_Wsuggest_attribute_format = 382,       /* -Wsuggest-attribute=format */
  OPT_Wsuggest_attribute_noreturn = 383,     /* -Wsuggest-attribute=noreturn */
  OPT_Wsuggest_attribute_pure = 384,         /* -Wsuggest-attribute=pure */
  OPT_Wsuggest_final_methods = 385,          /* -Wsuggest-final-methods */
  OPT_Wsuggest_final_types = 386,            /* -Wsuggest-final-types */
  OPT_Wsuggest_override = 387,               /* -Wsuggest-override */
  OPT_Wsurprising = 388,                     /* -Wsurprising */
  OPT_Wswitch = 389,                         /* -Wswitch */
  OPT_Wswitch_bool = 390,                    /* -Wswitch-bool */
  OPT_Wswitch_default = 391,                 /* -Wswitch-default */
  OPT_Wswitch_enum = 392,                    /* -Wswitch-enum */
  OPT_Wswitch_unreachable = 393,             /* -Wswitch-unreachable */
  OPT_Wsync_nand = 394,                      /* -Wsync-nand */
  OPT_Wsynth = 395,                          /* -Wsynth */
  OPT_Wsystem_headers = 396,                 /* -Wsystem-headers */
  OPT_Wtabs = 397,                           /* -Wtabs */
  OPT_Wtarget_lifetime = 398,                /* -Wtarget-lifetime */
  OPT_Wtautological_compare = 399,           /* -Wtautological-compare */
  OPT_Wtemplates = 400,                      /* -Wtemplates */
  OPT_Wterminate = 401,                      /* -Wterminate */
  OPT_Wtraditional = 402,                    /* -Wtraditional */
  OPT_Wtraditional_conversion = 403,         /* -Wtraditional-conversion */
  OPT_Wtrampolines = 404,                    /* -Wtrampolines */
  OPT_Wtrigraphs = 405,                      /* -Wtrigraphs */
  OPT_Wtype_limits = 406,                    /* -Wtype-limits */
  OPT_Wundeclared_selector = 407,            /* -Wundeclared-selector */
  OPT_Wundef = 408,                          /* -Wundef */
  OPT_Wundefined_do_loop = 409,              /* -Wundefined-do-loop */
  OPT_Wunderflow = 410,                      /* -Wunderflow */
  OPT_Wuninitialized = 411,                  /* -Wuninitialized */
  OPT_Wunknown_pragmas = 412,                /* -Wunknown-pragmas */
  /* OPT_Wunreachable_code = 413, */         /* -Wunreachable-code */
  OPT_Wunsafe_loop_optimizations = 414,      /* -Wunsafe-loop-optimizations */
  OPT_Wunsuffixed_float_constants = 415,     /* -Wunsuffixed-float-constants */
  OPT_Wunused = 416,                         /* -Wunused */
  OPT_Wunused_but_set_parameter = 417,       /* -Wunused-but-set-parameter */
  OPT_Wunused_but_set_variable = 418,        /* -Wunused-but-set-variable */
  /* OPT_Wunused_const_variable = 419, */    /* -Wunused-const-variable */
  OPT_Wunused_const_variable_ = 420,         /* -Wunused-const-variable= */
  OPT_Wunused_dummy_argument = 421,          /* -Wunused-dummy-argument */
  OPT_Wunused_function = 422,                /* -Wunused-function */
  OPT_Wunused_label = 423,                   /* -Wunused-label */
  OPT_Wunused_local_typedefs = 424,          /* -Wunused-local-typedefs */
  OPT_Wunused_macros = 425,                  /* -Wunused-macros */
  OPT_Wunused_parameter = 426,               /* -Wunused-parameter */
  OPT_Wunused_result = 427,                  /* -Wunused-result */
  OPT_Wunused_value = 428,                   /* -Wunused-value */
  OPT_Wunused_variable = 429,                /* -Wunused-variable */
  OPT_Wuse_without_only = 430,               /* -Wuse-without-only */
  OPT_Wuseless_cast = 431,                   /* -Wuseless-cast */
  ...
  OPT_Wvirtual_inheritance = 435,            /* -Wvirtual-inheritance */
  OPT_Wvirtual_move_assign = 436,            /* -Wvirtual-move-assign */
  OPT_Wvla = 437,                            /* -Wvla */
  OPT_Wvla_larger_than_ = 438,               /* -Wvla-larger-than= */
  OPT_Wvolatile_register_var = 439,          /* -Wvolatile-register-var */
  ...
  OPT_dumpfullversion = 459,                 /* -dumpfullversion */
  OPT_dumpmachine = 460,                     /* -dumpmachine */
  OPT_dumpspecs = 461,                       /* -dumpspecs */
  OPT_dumpversion = 462,                     /* -dumpversion */
  OPT_e = 463,                               /* -e */
  OPT_export_dynamic = 464,                  /* -export-dynamic */
  OPT_fPIC = 465,                            /* -fPIC */
  OPT_fPIE = 466,                            /* -fPIE */
  OPT_fRTS_ = 467,                           /* -fRTS= */
  OPT_fabi_compat_version_ = 468,            /* -fabi-compat-version= */
  OPT_fabi_version_ = 469,                   /* -fabi-version= */
  OPT_faccess_control = 470,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 471,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 472,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 473,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 474,                  /* -falign-commons */
  OPT_falign_functions = 475,                /* -falign-functions */
  OPT_falign_functions_ = 476,               /* -falign-functions= */
  OPT_falign_jumps = 477,                    /* -falign-jumps */
  OPT_falign_jumps_ = 478,                   /* -falign-jumps= */
  OPT_falign_labels = 479,                   /* -falign-labels */
  OPT_falign_labels_ = 480,                  /* -falign-labels= */
  OPT_falign_loops = 481,                    /* -falign-loops */
  OPT_falign_loops_ = 482,                   /* -falign-loops= */
  /* OPT_faligned_new = 483, */              /* -faligned-new */
  OPT_faligned_new_ = 484,                   /* -faligned-new= */
  ...
  OPT_fasynchronous_unwind_tables = 497,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 498,                   /* -fauto-inc-dec */
  OPT_fauto_profile = 499,                   /* -fauto-profile */
  OPT_fauto_profile_ = 500,                  /* -fauto-profile= */
  OPT_fautomatic = 501,                      /* -fautomatic */
  OPT_fbackslash = 502,                      /* -fbackslash */
  OPT_fbacktrace = 503,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 504,             /* -fblas-matmul-limit= */
  OPT_fbounds_check = 505,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 506,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 507,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 508,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 509,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 510,               /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 511,                /* -fbuilding-libgcc */
  OPT_fbuiltin = 512,                        /* -fbuiltin */
  OPT_fbuiltin_ = 513,                       /* -fbuiltin- */
  OPT_fbuiltin_printf = 514,                 /* -fbuiltin-printf */
  OPT_fc_prototypes = 515,                   /* -fc-prototypes */
  OPT_fcall_saved_ = 516,                    /* -fcall-saved- */
  OPT_fcall_used_ = 517,                     /* -fcall-used- */
  OPT_fcaller_saves = 518,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 519,       /* -fcanonical-system-headers */
  OPT_fcheck_array_temporaries = 520,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 521,                /* -fcheck-data-deps */
  OPT_fcheck_new = 522,                      /* -fcheck-new */
  OPT_fcheck_pointer_bounds = 523,           /* -fcheck-pointer-bounds */
  OPT_fcheck_ = 524,                         /* -fcheck= */
  OPT_fchecking = 525,                       /* -fchecking */
  OPT_fchecking_ = 526,                      /* -fchecking= */
  OPT_fchkp_check_incomplete_type = 527,     /* -fchkp-check-incomplete-type */
  OPT_fchkp_check_read = 528,                /* -fchkp-check-read */
  OPT_fchkp_check_write = 529,               /* -fchkp-check-write */
  OPT_fchkp_first_field_has_own_bounds = 530,/* -fchkp-first-field-has-own-bounds */
  OPT_fchkp_flexible_struct_trailing_arrays = 531,/* -fchkp-flexible-struct-trailing-arrays */
  OPT_fchkp_instrument_calls = 532,          /* -fchkp-instrument-calls */
  OPT_fchkp_instrument_marked_only = 533,    /* -fchkp-instrument-marked-only */
  OPT_fchkp_narrow_bounds = 534,             /* -fchkp-narrow-bounds */
  OPT_fchkp_narrow_to_innermost_array = 535, /* -fchkp-narrow-to-innermost-array */
  OPT_fchkp_optimize = 536,                  /* -fchkp-optimize */
  OPT_fchkp_store_bounds = 537,              /* -fchkp-store-bounds */
  OPT_fchkp_treat_zero_dynamic_size_as_infinite = 538,/* -fchkp-treat-zero-dynamic-size-as-infinite */
  OPT_fchkp_use_fast_string_functions = 539, /* -fchkp-use-fast-string-functions */
  OPT_fchkp_use_nochk_string_functions = 540,/* -fchkp-use-nochk-string-functions */
  OPT_fchkp_use_static_bounds = 541,         /* -fchkp-use-static-bounds */
  OPT_fchkp_use_static_const_bounds = 542,   /* -fchkp-use-static-const-bounds */
  OPT_fchkp_use_wrappers = 543,              /* -fchkp-use-wrappers */
  OPT_fchkp_zero_input_bounds_for_main = 544,/* -fchkp-zero-input-bounds-for-main */
  OPT_fcilkplus = 545,                       /* -fcilkplus */
  OPT_fcoarray_ = 546,                       /* -fcoarray= */
  OPT_fcode_hoisting = 547,                  /* -fcode-hoisting */
  OPT_fcombine_stack_adjustments = 548,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 549,                         /* -fcommon */
  OPT_fcompare_debug = 550,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 551,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 552,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 553,                   /* -fcompare-elim */
  OPT_fconcepts = 554,                       /* -fconcepts */
  OPT_fcond_mismatch = 555,                  /* -fcond-mismatch */
  OPT_fconserve_space = 556,                 /* -fconserve-space */
  OPT_fconserve_stack = 557,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 558,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 559,               /* -fconstexpr-depth= */
  OPT_fconstexpr_loop_limit_ = 560,          /* -fconstexpr-loop-limit= */
  ...
  OPT_fdec = 578,                            /* -fdec */
  OPT_fdec_intrinsic_ints = 579,             /* -fdec-intrinsic-ints */
  OPT_fdec_math = 580,                       /* -fdec-math */
  OPT_fdec_static = 581,                     /* -fdec-static */
  OPT_fdec_structure = 582,                  /* -fdec-structure */
  OPT_fdeclone_ctor_dtor = 583,              /* -fdeclone-ctor-dtor */
  OPT_fdeduce_init_list = 584,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 585,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 586, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 587,              /* -fdefault-integer-8 */
  OPT_fdefault_real_8 = 588,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 589,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 590,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 591,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 592,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 593,                   /* -fdevirtualize */
  OPT_fdevirtualize_at_ltrans = 594,         /* -fdevirtualize-at-ltrans */
  ...
  OPT_fdiagnostics_generate_patch = 598,     /* -fdiagnostics-generate-patch */
  OPT_fdiagnostics_parseable_fixits = 599,   /* -fdiagnostics-parseable-fixits */
  OPT_fdiagnostics_show_caret = 600,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_location_ = 601,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 602,        /* -fdiagnostics-show-option */
  OPT_fdiagnostics_show_template_tree = 603, /* -fdiagnostics-show-template-tree */
  OPT_fdirectives_only = 604,                /* -fdirectives-only */
  OPT_fdisable_ = 605,                       /* -fdisable- */
  OPT_fdollar_ok = 606,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 607,         /* -fdollars-in-identifiers */
  OPT_fdse = 608,                            /* -fdse */
  OPT_fdump_ = 609,                          /* -fdump- */
  OPT_fdump_ada_spec = 610,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 611,             /* -fdump-ada-spec-slim */
  /* OPT_fdump_core = 612, */                /* -fdump-core */
  OPT_fdump_final_insns = 613,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 614,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 615,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 616,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 617,                  /* -fdump-go-spec= */
  OPT_fdump_internal_locations = 618,        /* -fdump-internal-locations */
  OPT_fdump_noaddr = 619,                    /* -fdump-noaddr */
  /* OPT_fdump_parse_tree = 620, */          /* -fdump-parse-tree */
  OPT_fdump_passes = 621,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 622,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 623,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 624,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 625,                 /* -fearly-inlining */
  OPT_felide_constructors = 626,             /* -felide-constructors */
  OPT_felide_type = 627,                     /* -felide-type */
  OPT_feliminate_dwarf2_dups = 628,          /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 629, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 630,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 631,        /* -femit-class-debug-always */
  OPT_femit_struct_debug_baseonly = 632,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 633,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 634,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 635,                        /* -fenable- */
  ...
  OPT_fextended_identifiers = 643,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 644,                /* -fextern-tls-init */
  OPT_fexternal_blas = 645,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 646, */       /* -fexternal-templates */
  OPT_ff2c = 647,                            /* -ff2c */
  OPT_ffast_math = 648,                      /* -ffast-math */
  OPT_ffat_lto_objects = 649,                /* -ffat-lto-objects */
  ...
  OPT_ffp_int_builtin_inexact = 660,         /* -ffp-int-builtin-inexact */
  ...
  OPT_fgimple = 676,                         /* -fgimple */
  OPT_fgnat_encodings_ = 677,                /* -fgnat-encodings= */
  ...
  OPT_fgo_c_header_ = 683,                   /* -fgo-c-header= */
  OPT_fgo_check_divide_overflow = 684,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 685,           /* -fgo-check-divide-zero */
  OPT_fgo_compiling_runtime = 686,           /* -fgo-compiling-runtime */
  OPT_fgo_debug_escape = 687,                /* -fgo-debug-escape */
  OPT_fgo_dump_ = 688,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 689,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 690,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 691,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 692,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 693,                       /* -fgraphite */
  OPT_fgraphite_identity = 694,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 695,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 696, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 697, */        /* -fhandle-exceptions */
  /* OPT_fhelp = 698, */                     /* -fhelp */
  ...
  OPT_fimplement_inlines = 707,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 708,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 709,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 710,             /* -fimplicit-templates */
  ...
  OPT_finit_derived = 714,                   /* -finit-derived */
  OPT_finit_integer_ = 715,                  /* -finit-integer= */
  OPT_finit_local_zero = 716,                /* -finit-local-zero */
  OPT_finit_logical_ = 717,                  /* -finit-logical= */
  OPT_finit_real_ = 718,                     /* -finit-real= */
  OPT_finline = 719,                         /* -finline */
  OPT_finline_atomics = 720,                 /* -finline-atomics */
  OPT_finline_functions = 721,               /* -finline-functions */
  OPT_finline_functions_called_once = 722,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 723, */            /* -finline-limit- */
  OPT_finline_limit_ = 724,                  /* -finline-limit= */
  OPT_finline_matmul_limit_ = 725,           /* -finline-matmul-limit= */
  OPT_finline_small_functions = 726,         /* -finline-small-functions */
  OPT_finput_charset_ = 727,                 /* -finput-charset= */
  OPT_finstrument_functions = 728,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 729,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 730,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 731,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 732,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 733,        /* -fintrinsic-modules-path= */
  OPT_fipa_bit_cp = 734,                     /* -fipa-bit-cp */
  OPT_fipa_cp = 735,                         /* -fipa-cp */
  /* OPT_fipa_cp_alignment = 736, */         /* -fipa-cp-alignment */
  OPT_fipa_cp_clone = 737,                   /* -fipa-cp-clone */
  OPT_fipa_icf = 738,                        /* -fipa-icf */
  OPT_fipa_icf_functions = 739,              /* -fipa-icf-functions */
  OPT_fipa_icf_variables = 740,              /* -fipa-icf-variables */
  /* OPT_fipa_matrix_reorg = 741, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 742,                    /* -fipa-profile */
  OPT_fipa_pta = 743,                        /* -fipa-pta */
  OPT_fipa_pure_const = 744,                 /* -fipa-pure-const */
  OPT_fipa_ra = 745,                         /* -fipa-ra */
  OPT_fipa_reference = 746,                  /* -fipa-reference */
  OPT_fipa_sra = 747,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 748, */         /* -fipa-struct-reorg */
  OPT_fipa_vrp = 749,                        /* -fipa-vrp */
  OPT_fira_algorithm_ = 750,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 751,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 752,              /* -fira-loop-pressure */
  OPT_fira_region_ = 753,                    /* -fira-region= */
  OPT_fira_share_save_slots = 754,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 755,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 756,                   /* -fira-verbose= */
  OPT_fisolate_erroneous_paths_attribute = 757,/* -fisolate-erroneous-paths-attribute */
  OPT_fisolate_erroneous_paths_dereference = 758,/* -fisolate-erroneous-paths-dereference */
  OPT_fivar_visibility_ = 759,               /* -fivar-visibility= */
  OPT_fivopts = 760,                         /* -fivopts */
  OPT_fjump_tables = 761,                    /* -fjump-tables */
  OPT_fkeep_gc_roots_live = 762,             /* -fkeep-gc-roots-live */
  OPT_fkeep_inline_dllexport = 763,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 764,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 765,             /* -fkeep-static-consts */
  OPT_fkeep_static_functions = 766,          /* -fkeep-static-functions */
  /* OPT_flabels_ok = 767, */                /* -flabels-ok */
  OPT_flax_vector_conversions = 768,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 769,             /* -fleading-underscore */
  OPT_flifetime_dse = 770,                   /* -flifetime-dse */
  OPT_flifetime_dse_ = 771,                  /* -flifetime-dse= */
  OPT_flimit_function_alignment = 772,       /* -flimit-function-alignment */
  OPT_flinker_output_ = 773,                 /* -flinker-output= */
  OPT_flive_range_shrinkage = 774,           /* -flive-range-shrinkage */
  OPT_flocal_ivars = 775,                    /* -flocal-ivars */
  /* OPT_floop_block = 776, */               /* -floop-block */
  /* OPT_floop_flatten = 777, */             /* -floop-flatten */
  /* OPT_floop_interchange = 778, */         /* -floop-interchange */
  OPT_floop_nest_optimize = 779,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 780, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 781,           /* -floop-parallelize-all */
  /* OPT_floop_strip_mine = 782, */          /* -floop-strip-mine */
  /* OPT_floop_unroll_and_jam = 783, */      /* -floop-unroll-and-jam */
  OPT_flra_remat = 784,                      /* -flra-remat */
  OPT_flto = 785,                            /* -flto */
  OPT_flto_compression_level_ = 786,         /* -flto-compression-level= */
  OPT_flto_odr_type_merging = 787,           /* -flto-odr-type-merging */
  OPT_flto_partition_ = 788,                 /* -flto-partition= */
  OPT_flto_report = 789,                     /* -flto-report */
  OPT_flto_report_wpa = 790,                 /* -flto-report-wpa */
  OPT_flto_ = 791,                           /* -flto= */
  OPT_fltrans = 792,                         /* -fltrans */
  OPT_fltrans_output_list_ = 793,            /* -fltrans-output-list= */
  OPT_fmath_errno = 794,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 795,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 796,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 797,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 798,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 799,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 800,                     /* -fmem-report */
  OPT_fmem_report_wpa = 801,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 802,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 803,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 804,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 805,                /* -fmessage-length= */
  OPT_fmodule_private = 806,                 /* -fmodule-private */
  OPT_fmodulo_sched = 807,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 808,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 809,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 810,                  /* -fms-extensions */
  /* OPT_fmudflap = 811, */                  /* -fmudflap */
  /* OPT_fmudflapir = 812, */                /* -fmudflapir */
  /* OPT_fmudflapth = 813, */                /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 814, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 815, */                  /* -fnew-abi */
  OPT_fnew_inheriting_ctors = 816,           /* -fnew-inheriting-ctors */
  OPT_fnew_ttp_matching = 817,               /* -fnew-ttp-matching */
  OPT_fnext_runtime = 818,                   /* -fnext-runtime */
  OPT_fnil_receivers = 819,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 820,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 821,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 822, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 823,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 824,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 825,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 826,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 827,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 828,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 829,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 830,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 831,                 /* -fobjc-std=objc1 */
  OPT_foffload_abi_ = 832,                   /* -foffload-abi= */
  OPT_foffload_ = 833,                       /* -foffload= */
  OPT_fomit_frame_pointer = 834,             /* -fomit-frame-pointer */
  OPT_fopenacc = 835,                        /* -fopenacc */
  OPT_fopenacc_dim_ = 836,                   /* -fopenacc-dim= */
  OPT_fopenmp = 837,                         /* -fopenmp */
  OPT_fopenmp_simd = 838,                    /* -fopenmp-simd */
  OPT_foperator_names = 839,                 /* -foperator-names */
  OPT_fopt_info = 840,                       /* -fopt-info */
  OPT_fopt_info_ = 841,                      /* -fopt-info- */
  /* OPT_foptimize_register_move = 842, */   /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 843,         /* -foptimize-sibling-calls */
  OPT_foptimize_strlen = 844,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 845, */           /* -foptional-diags */
  OPT_fpack_derived = 846,                   /* -fpack-derived */
  OPT_fpack_struct = 847,                    /* -fpack-struct */
  OPT_fpack_struct_ = 848,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 849,               /* -fpartial-inlining */
  OPT_fpatchable_function_entry_ = 850,      /* -fpatchable-function-entry= */
  OPT_fpcc_struct_return = 851,              /* -fpcc-struct-return */
  OPT_fpch_deps = 852,                       /* -fpch-deps */
  OPT_fpch_preprocess = 853,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 854,                     /* -fpeel-loops */
  OPT_fpeephole = 855,                       /* -fpeephole */
  OPT_fpeephole2 = 856,                      /* -fpeephole2 */
  OPT_fpermissive = 857,                     /* -fpermissive */
  OPT_fpermitted_flt_eval_methods_ = 858,    /* -fpermitted-flt-eval-methods= */
  OPT_fpic = 859,                            /* -fpic */
  OPT_fpie = 860,                            /* -fpie */
  OPT_fplan9_extensions = 861,               /* -fplan9-extensions */
  OPT_fplt = 862,                            /* -fplt */
  OPT_fplugin_arg_ = 863,                    /* -fplugin-arg- */
  OPT_fplugin_ = 864,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 865,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 866,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 867,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 868,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 869,                   /* -fpreprocessed */
  OPT_fpretty_templates = 870,               /* -fpretty-templates */
  OPT_fprintf_return_value = 871,            /* -fprintf-return-value */
  OPT_fprofile = 872,                        /* -fprofile */
  OPT_fprofile_abs_path = 873,               /* -fprofile-abs-path */
  OPT_fprofile_arcs = 874,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 875,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 876,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 877,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 878,              /* -fprofile-generate= */
  OPT_fprofile_reorder_functions = 879,      /* -fprofile-reorder-functions */
  OPT_fprofile_report = 880,                 /* -fprofile-report */
  OPT_fprofile_update_ = 881,                /* -fprofile-update= */
  OPT_fprofile_use = 882,                    /* -fprofile-use */
  OPT_fprofile_use_ = 883,                   /* -fprofile-use= */
  OPT_fprofile_values = 884,                 /* -fprofile-values */
  OPT_fprotect_parens = 885,                 /* -fprotect-parens */
  OPT_frandom_seed = 886,                    /* -frandom-seed */
  OPT_frandom_seed_ = 887,                   /* -frandom-seed= */
  OPT_frange_check = 888,                    /* -frange-check */
  OPT_freal_4_real_10 = 889,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 890,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 891,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 892,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 893,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 894,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 895,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 896,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 897,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 898,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 899,                /* -frecord-marker=8 */
  OPT_frecursive = 900,                      /* -frecursive */
  OPT_free = 901,                            /* -free */
  OPT_freg_struct_return = 902,              /* -freg-struct-return */
  /* OPT_fregmove = 903, */                  /* -fregmove */
  OPT_frename_registers = 904,               /* -frename-registers */
  OPT_freorder_blocks = 905,                 /* -freorder-blocks */
  OPT_freorder_blocks_algorithm_ = 906,      /* -freorder-blocks-algorithm= */
  OPT_freorder_blocks_and_partition = 907,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 908,              /* -freorder-functions */
  OPT_frepack_arrays = 909,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 910,           /* -freplace-objc-classes */
  OPT_frepo = 911,                           /* -frepo */
  OPT_freport_bug = 912,                     /* -freport-bug */
  OPT_frequire_return_statement = 913,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 914,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 915, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 916,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 917,                    /* -fresolution= */
  OPT_frounding_math = 918,                  /* -frounding-math */
  OPT_frtti = 919,                           /* -frtti */
  OPT_fsanitize_address_use_after_scope = 920,/* -fsanitize-address-use-after-scope */
  OPT_fsanitize_coverage_trace_pc = 921,     /* -fsanitize-coverage=trace-pc */
  OPT_fsanitize_recover = 922,               /* -fsanitize-recover */
  OPT_fsanitize_recover_ = 923,              /* -fsanitize-recover= */
  OPT_fsanitize_sections_ = 924,             /* -fsanitize-sections= */
  OPT_fsanitize_undefined_trap_on_error = 925,/* -fsanitize-undefined-trap-on-error */
  OPT_fsanitize_ = 926,                      /* -fsanitize= */
  OPT_fsched_critical_path_heuristic = 927,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 928,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 929,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 930,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 931,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 932,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 933,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 934,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 935,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 936,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 937,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 938,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 939,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 940,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 941,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 942,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 943,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 944, */        /* -fsched2-use-traces */
  OPT_fschedule_fusion = 945,                /* -fschedule-fusion */
  OPT_fschedule_insns = 946,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 947,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 948,              /* -fsecond-underscore */
  OPT_fsection_anchors = 949,                /* -fsection-anchors */
  /* OPT_fsee = 950, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 951,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 952,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 953, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 954,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 955,          /* -fselective-scheduling2 */
  OPT_fself_test_ = 956,                     /* -fself-test= */
  OPT_fsemantic_interposition = 957,         /* -fsemantic-interposition */
  OPT_fshort_enums = 958,                    /* -fshort-enums */
  OPT_fshort_wchar = 959,                    /* -fshort-wchar */
  OPT_fshow_column = 960,                    /* -fshow-column */
  OPT_fshrink_wrap = 961,                    /* -fshrink-wrap */
  OPT_fshrink_wrap_separate = 962,           /* -fshrink-wrap-separate */
  OPT_fsign_zero = 963,                      /* -fsign-zero */
  OPT_fsignaling_nans = 964,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 965,               /* -fsigned-bitfields */
  OPT_fsigned_char = 966,                    /* -fsigned-char */
  OPT_fsigned_zeros = 967,                   /* -fsigned-zeros */
  OPT_fsimd_cost_model_ = 968,               /* -fsimd-cost-model= */
  OPT_fsingle_precision_constant = 969,      /* -fsingle-precision-constant */
  OPT_fsized_deallocation = 970,             /* -fsized-deallocation */
  OPT_fsplit_ivs_in_unroller = 971,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_loops = 972,                    /* -fsplit-loops */
  OPT_fsplit_paths = 973,                    /* -fsplit-paths */
  OPT_fsplit_stack = 974,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 975,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 976, */                 /* -fsquangle */
  OPT_fssa_backprop = 977,                   /* -fssa-backprop */
  OPT_fssa_phiopt = 978,                     /* -fssa-phiopt */
  OPT_fsso_struct_ = 979,                    /* -fsso-struct= */
  OPT_fstack_arrays = 980,                   /* -fstack-arrays */
  /* OPT_fstack_check = 981, */              /* -fstack-check */
  OPT_fstack_check_ = 982,                   /* -fstack-check= */
  OPT_fstack_limit = 983,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 984,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 985,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 986,                /* -fstack-protector */
  OPT_fstack_protector_all = 987,            /* -fstack-protector-all */
  OPT_fstack_protector_explicit = 988,       /* -fstack-protector-explicit */
  OPT_fstack_protector_strong = 989,         /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 990,                   /* -fstack-reuse= */
  OPT_fstack_usage = 991,                    /* -fstack-usage */
  OPT_fstats = 992,                          /* -fstats */
  OPT_fstdarg_opt = 993,                     /* -fstdarg-opt */
  OPT_fstore_merging = 994,                  /* -fstore-merging */
  /* OPT_fstrength_reduce = 995, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 996,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 997,                   /* -fstrict-enums */
  /* OPT_fstrict_overflow = 998, */          /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 999, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 1000,     /* -fstrict-volatile-bitfields */
  /* OPT_fstrong_eval_order = 1001, */       /* -fstrong-eval-order */
  OPT_fstrong_eval_order_ = 1002,            /* -fstrong-eval-order= */
  OPT_fsync_libcalls = 1003,                 /* -fsync-libcalls */
  OPT_fsyntax_only = 1004,                   /* -fsyntax-only */
  OPT_ftabstop_ = 1005,                      /* -ftabstop= */
  /* OPT_ftarget_help = 1006, */             /* -ftarget-help */
  OPT_ftemplate_backtrace_limit_ = 1007,     /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 1008, */         /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 1009,               /* -ftemplate-depth= */
  OPT_ftest_coverage = 1010,                 /* -ftest-coverage */
  OPT_ftest_forall_temp = 1011,              /* -ftest-forall-temp */
  /* OPT_fthis_is_variable = 1012, */        /* -fthis-is-variable */
  OPT_fthread_jumps = 1013,                  /* -fthread-jumps */
  OPT_fthreadsafe_statics = 1014,            /* -fthreadsafe-statics */
  OPT_ftime_report = 1015,                   /* -ftime-report */
  OPT_ftime_report_details = 1016,           /* -ftime-report-details */
  OPT_ftls_model_ = 1017,                    /* -ftls-model= */
  OPT_ftoplevel_reorder = 1018,              /* -ftoplevel-reorder */
  OPT_ftracer = 1019,                        /* -ftracer */
  OPT_ftrack_macro_expansion = 1020,         /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 1021,        /* -ftrack-macro-expansion= */
  OPT_ftrampolines = 1022,                   /* -ftrampolines */
  OPT_ftrapping_math = 1023,                 /* -ftrapping-math */
  OPT_ftrapv = 1024,                         /* -ftrapv */
  OPT_ftree_bit_ccp = 1025,                  /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 1026,         /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 1027,                      /* -ftree-ccp */
  OPT_ftree_ch = 1028,                       /* -ftree-ch */
  /* OPT_ftree_coalesce_inlined_vars = 1029, *//* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 1030,            /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 1031,                /* -ftree-copy-prop */
  /* OPT_ftree_copyrename = 1032, */         /* -ftree-copyrename */
  OPT_ftree_cselim = 1033,                   /* -ftree-cselim */
  OPT_ftree_dce = 1034,                      /* -ftree-dce */
  OPT_ftree_dominator_opts = 1035,           /* -ftree-dominator-opts */
  OPT_ftree_dse = 1036,                      /* -ftree-dse */
  OPT_ftree_forwprop = 1037,                 /* -ftree-forwprop */
  OPT_ftree_fre = 1038,                      /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 1039, /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 1040,        /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 1041,          /* -ftree-loop-if-convert */
  /* OPT_ftree_loop_if_convert_stores = 1042, *//* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 1043,                  /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 1044,             /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 1045, */        /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 1046,            /* -ftree-loop-optimize */
  OPT_ftree_loop_vectorize = 1047,           /* -ftree-loop-vectorize */
  OPT_ftree_lrs = 1048,                      /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1049,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1050,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1051,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1052,                      /* -ftree-pre */
  OPT_ftree_pta = 1053,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1054,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1055, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1056,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1057,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1058,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1059,                     /* -ftree-slsr */
  OPT_ftree_sra = 1060,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1061, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1062, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1063,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1064,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1065,                      /* -ftree-ter */
  /* OPT_ftree_vect_loop_version = 1066, */  /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1067,                /* -ftree-vectorize */
  /* OPT_ftree_vectorizer_verbose_ = 1068, *//* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1069,                      /* -ftree-vrp */
  OPT_funconstrained_commons = 1070,         /* -funconstrained-commons */
  OPT_funderscoring = 1071,                  /* -funderscoring */
  OPT_funit_at_a_time = 1072,                /* -funit-at-a-time */
  OPT_funroll_all_loops = 1073,              /* -funroll-all-loops */
  OPT_funroll_loops = 1074,                  /* -funroll-loops */
  /* OPT_funsafe_loop_optimizations = 1075, *//* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1076,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1077,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1078,                 /* -funsigned-char */
  OPT_funswitch_loops = 1079,                /* -funswitch-loops */
  OPT_funwind_tables = 1080,                 /* -funwind-tables */
  OPT_fuse_cxa_atexit = 1081,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1082,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_ld_bfd = 1083,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1084,                   /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 1085,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1086,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1087,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1088,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1089,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1090,/* -fvariable-expansion-in-unroller */
  /* OPT_fvect_cost_model = 1091, */         /* -fvect-cost-model */
  OPT_fvect_cost_model_ = 1092,              /* -fvect-cost-model= */
  OPT_fverbose_asm = 1093,                   /* -fverbose-asm */
  /* OPT_fversion = 1094, */                 /* -fversion */
  OPT_fvisibility_inlines_hidden = 1095,     /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 1096,          /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 1097,                   /* -fvisibility= */
  OPT_fvpt = 1098,                           /* -fvpt */
  /* OPT_fvtable_gc = 1099, */               /* -fvtable-gc */
  /* OPT_fvtable_thunks = 1100, */           /* -fvtable-thunks */
  OPT_fvtable_verify_ = 1101,                /* -fvtable-verify= */
  OPT_fvtv_counts = 1102,                    /* -fvtv-counts */
  OPT_fvtv_debug = 1103,                     /* -fvtv-debug */
  OPT_fweak = 1104,                          /* -fweak */
  OPT_fweb = 1105,                           /* -fweb */
  /* OPT_fwhole_file = 1106, */              /* -fwhole-file */
  OPT_fwhole_program = 1107,                 /* -fwhole-program */
  OPT_fwide_exec_charset_ = 1108,            /* -fwide-exec-charset= */
  OPT_fworking_directory = 1109,             /* -fworking-directory */
  OPT_fwpa = 1110,                           /* -fwpa */
  OPT_fwpa_ = 1111,                          /* -fwpa= */
  OPT_fwrapv = 1112,                         /* -fwrapv */
  /* OPT_fxref = 1113, */                    /* -fxref */
  /* OPT_fzee = 1114, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1115,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1116,                     /* -fzero-link */
  OPT_g = 1117,                              /* -g */
  OPT_gant = 1118,                           /* -gant */
  OPT_gcoff = 1119,                          /* -gcoff */
  OPT_gcolumn_info = 1120,                   /* -gcolumn-info */
  OPT_gdwarf = 1121,                         /* -gdwarf */
  OPT_gdwarf_ = 1122,                        /* -gdwarf- */
  OPT_gen_decls = 1123,                      /* -gen-decls */
  OPT_ggdb = 1124,                           /* -ggdb */
  OPT_ggnu_pubnames = 1125,                  /* -ggnu-pubnames */
  OPT_gnat = 1126,                           /* -gnat */
  OPT_gnatO = 1127,                          /* -gnatO */
  OPT_gno_column_info = 1128,                /* -gno-column-info */
  OPT_gno_pubnames = 1129,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1130,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1131,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1132,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1133,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1134,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1135,                   /* -gsplit-dwarf */
  OPT_gstabs = 1136,                         /* -gstabs */
  OPT_gstabs_ = 1137,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1138,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1139,                        /* -gtoggle */
  OPT_gvms = 1140,                           /* -gvms */
  OPT_gxcoff = 1141,                         /* -gxcoff */
  OPT_gxcoff_ = 1142,                        /* -gxcoff+ */
  OPT_gz = 1143,                             /* -gz */
  OPT_gz_ = 1144,                            /* -gz= */
  OPT_h = 1145,                              /* -h */
  OPT_idirafter = 1146,                      /* -idirafter */
  OPT_imacros = 1147,                        /* -imacros */
  OPT_imultiarch = 1148,                     /* -imultiarch */
  OPT_imultilib = 1149,                      /* -imultilib */
  OPT_include = 1150,                        /* -include */
  OPT_iplugindir_ = 1151,                    /* -iplugindir= */
  OPT_iprefix = 1152,                        /* -iprefix */
  OPT_iquote = 1153,                         /* -iquote */
  OPT_isysroot = 1154,                       /* -isysroot */
  OPT_isystem = 1155,                        /* -isystem */
  OPT_iwithprefix = 1156,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1157,              /* -iwithprefixbefore */
  OPT_k8 = 1158,                             /* -k8 */
  OPT_l = 1159,                              /* -l */
  OPT_lang_asm = 1160,                       /* -lang-asm */
  OPT_m128bit_long_double = 1161,            /* -m128bit-long-double */
  OPT_m16 = 1162,                            /* -m16 */
  OPT_m32 = 1163,                            /* -m32 */
  OPT_m3dnow = 1164,                         /* -m3dnow */
  OPT_m3dnowa = 1165,                        /* -m3dnowa */
  OPT_m64 = 1166,                            /* -m64 */
  OPT_m80387 = 1167,                         /* -m80387 */
  OPT_m8bit_idiv = 1168,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1169,             /* -m96bit-long-double */
  OPT_mabi_ = 1170,                          /* -mabi= */
  OPT_mabm = 1171,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1172,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1173,                 /* -maddress-mode= */
  OPT_madx = 1174,                           /* -madx */
  OPT_maes = 1175,                           /* -maes */
  OPT_malign_data_ = 1176,                   /* -malign-data= */
  OPT_malign_double = 1177,                  /* -malign-double */
  OPT_malign_functions_ = 1178,              /* -malign-functions= */
  OPT_malign_jumps_ = 1179,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1180,                  /* -malign-loops= */
  OPT_malign_stringops = 1181,               /* -malign-stringops */
  OPT_march_ = 1182,                         /* -march= */
  OPT_masm_ = 1183,                          /* -masm= */
  OPT_mavx = 1184,                           /* -mavx */
  OPT_mavx2 = 1185,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1186,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1187,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1188,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1189,                  /* -mavx5124vnniw */
  OPT_mavx512bw = 1190,                      /* -mavx512bw */
  OPT_mavx512cd = 1191,                      /* -mavx512cd */
  OPT_mavx512dq = 1192,                      /* -mavx512dq */
  OPT_mavx512er = 1193,                      /* -mavx512er */
  OPT_mavx512f = 1194,                       /* -mavx512f */
  OPT_mavx512ifma = 1195,                    /* -mavx512ifma */
  OPT_mavx512pf = 1196,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1197,                    /* -mavx512vbmi */
  OPT_mavx512vl = 1198,                      /* -mavx512vl */
  OPT_mavx512vpopcntdq = 1199,               /* -mavx512vpopcntdq */
  OPT_mbmi = 1200,                           /* -mbmi */
  OPT_mbmi2 = 1201,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1202,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1203,          /* -mcall-ms2sysv-xlogues */
  OPT_mcld = 1204,                           /* -mcld */
  OPT_mclflushopt = 1205,                    /* -mclflushopt */
  OPT_mclwb = 1206,                          /* -mclwb */
  OPT_mclzero = 1207,                        /* -mclzero */
  OPT_mcmodel_ = 1208,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1209, */                    /* -mcpu= */
  OPT_mcrc32 = 1210,                         /* -mcrc32 */
  OPT_mcx16 = 1211,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1212,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1213,            /* -mdump-tune-features */
  OPT_mf16c = 1214,                          /* -mf16c */
  OPT_mfancy_math_387 = 1215,                /* -mfancy-math-387 */
  OPT_mfentry = 1216,                        /* -mfentry */
  OPT_mfma = 1217,                           /* -mfma */
  OPT_mfma4 = 1218,                          /* -mfma4 */
  OPT_mforce_drap = 1219,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1220,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1221,                       /* -mfpmath= */
  OPT_mfsgsbase = 1222,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1223, */              /* -mfused-madd */
  OPT_mfxsr = 1224,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1225,             /* -mgeneral-regs-only */
  OPT_mhard_float = 1226,                    /* -mhard-float */
  OPT_mhle = 1227,                           /* -mhle */
  OPT_miamcu = 1228,                         /* -miamcu */
  OPT_mieee_fp = 1229,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1230,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1231,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1232,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1233, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1234,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1235,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1236,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1237,                /* -mlong-double-80 */
  OPT_mlwp = 1238,                           /* -mlwp */
  OPT_mlzcnt = 1239,                         /* -mlzcnt */
  OPT_mmemcpy_strategy_ = 1240,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1241,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1242,                  /* -mmitigate-rop */
  OPT_mmmx = 1243,                           /* -mmmx */
  OPT_mmovbe = 1244,                         /* -mmovbe */
  OPT_mmpx = 1245,                           /* -mmpx */
  OPT_mms_bitfields = 1246,                  /* -mms-bitfields */
  OPT_mmwaitx = 1247,                        /* -mmwaitx */
  OPT_mno_align_stringops = 1248,            /* -mno-align-stringops */
  OPT_mno_default = 1249,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1250,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1251,                  /* -mno-push-args */
  OPT_mno_red_zone = 1252,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1253,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1254,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1255,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1256,                          /* -mpc32 */
  OPT_mpc64 = 1257,                          /* -mpc64 */
  OPT_mpc80 = 1258,                          /* -mpc80 */
  OPT_mpclmul = 1259,                        /* -mpclmul */
  OPT_mpcommit = 1260,                       /* -mpcommit */
  OPT_mpku = 1261,                           /* -mpku */
  OPT_mpopcnt = 1262,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1263,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1264,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1265,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1266,                        /* -mprfchw */
  OPT_mpush_args = 1267,                     /* -mpush-args */
  OPT_mrdpid = 1268,                         /* -mrdpid */
  OPT_mrdrnd = 1269,                         /* -mrdrnd */
  OPT_mrdseed = 1270,                        /* -mrdseed */
  OPT_mrecip = 1271,                         /* -mrecip */
  OPT_mrecip_ = 1272,                        /* -mrecip= */
  OPT_mrecord_mcount = 1273,                 /* -mrecord-mcount */
  OPT_mred_zone = 1274,                      /* -mred-zone */
  OPT_mregparm_ = 1275,                      /* -mregparm= */
  OPT_mrtd = 1276,                           /* -mrtd */
  OPT_mrtm = 1277,                           /* -mrtm */
  OPT_msahf = 1278,                          /* -msahf */
  OPT_msgx = 1279,                           /* -msgx */
  OPT_msha = 1280,                           /* -msha */
  OPT_mskip_rax_setup = 1281,                /* -mskip-rax-setup */
  OPT_msoft_float = 1282,                    /* -msoft-float */
  OPT_msse = 1283,                           /* -msse */
  OPT_msse2 = 1284,                          /* -msse2 */
  OPT_msse2avx = 1285,                       /* -msse2avx */
  OPT_msse3 = 1286,                          /* -msse3 */
  OPT_msse4 = 1287,                          /* -msse4 */
  OPT_msse4_1 = 1288,                        /* -msse4.1 */
  OPT_msse4_2 = 1289,                        /* -msse4.2 */
  OPT_msse4a = 1290,                         /* -msse4a */
  /* OPT_msse5 = 1291, */                    /* -msse5 */
  OPT_msseregparm = 1292,                    /* -msseregparm */
  OPT_mssse3 = 1293,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1294,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 1295, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1296,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 1297, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1298,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1299,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1300,            /* -mstringop-strategy= */
  OPT_mstv = 1301,                           /* -mstv */
  OPT_mtbm = 1302,                           /* -mtbm */
  OPT_mtls_dialect_ = 1303,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1304,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1305,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1306,                         /* -mtune= */
  OPT_mveclibabi_ = 1307,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1308,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1309,                    /* -mvzeroupper */
  OPT_mx32 = 1310,                           /* -mx32 */
  OPT_mxop = 1311,                           /* -mxop */
  OPT_mxsave = 1312,                         /* -mxsave */
  OPT_mxsavec = 1313,                        /* -mxsavec */
  OPT_mxsaveopt = 1314,                      /* -mxsaveopt */
  OPT_mxsaves = 1315,                        /* -mxsaves */
  OPT_n = 1316,                              /* -n */
  OPT_no_canonical_prefixes = 1317,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1318,              /* -no-integrated-cpp */
  OPT_no_pie = 1319,                         /* -no-pie */
  OPT_nocpp = 1320,                          /* -nocpp */
  OPT_nodefaultlibs = 1321,                  /* -nodefaultlibs */
  ...
  OPT_o = 1326,                              /* -o */
  OPT_p = 1327,                              /* -p */
  OPT_pass_exit_codes = 1328,                /* -pass-exit-codes */
  /* OPT_pedantic = 1329, */                 /* -pedantic */
  OPT_pedantic_errors = 1330,                /* -pedantic-errors */
  OPT_pg = 1331,                             /* -pg */
  OPT_pie = 1332,                            /* -pie */
  OPT_pipe = 1333,                           /* -pipe */
  OPT_print_file_name_ = 1334,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1335,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1336,          /* -print-multi-directory */
  OPT_print_multi_lib = 1337,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1338,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1339,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1340,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1341,               /* -print-prog-name= */
  OPT_print_search_dirs = 1342,              /* -print-search-dirs */
  OPT_print_sysroot = 1343,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1344,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1345,                          /* -quiet */
  OPT_r = 1346,                              /* -r */
  OPT_remap = 1347,                          /* -remap */
  OPT_s = 1348,                              /* -s */
  OPT_save_temps = 1349,                     /* -save-temps */
  OPT_save_temps_ = 1350,                    /* -save-temps= */
  OPT_shared = 1351,                         /* -shared */
  OPT_shared_libgcc = 1352,                  /* -shared-libgcc */
  /* OPT_specs = 1353, */                    /* -specs */
  OPT_specs_ = 1354,                         /* -specs= */
  OPT_static = 1355,                         /* -static */
  OPT_static_libasan = 1356,                 /* -static-libasan */
  OPT_static_libgcc = 1357,                  /* -static-libgcc */
  OPT_static_libgfortran = 1358,             /* -static-libgfortran */
  OPT_static_libgo = 1359,                   /* -static-libgo */
  OPT_static_liblsan = 1360,                 /* -static-liblsan */
  OPT_static_libmpx = 1361,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1362,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1363,               /* -static-libstdc++ */
  OPT_static_libtsan = 1364,                 /* -static-libtsan */
  OPT_static_libubsan = 1365,                /* -static-libubsan */
  /* OPT_std_c__03 = 1366, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1367, */                /* -std=c++0x */
  OPT_std_c__11 = 1368,                      /* -std=c++11 */
  OPT_std_c__14 = 1369,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1370, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1371, */                /* -std=c++1y */
  OPT_std_c__1z = 1372,                      /* -std=c++1z */
  OPT_std_c__98 = 1373,                      /* -std=c++98 */
  OPT_std_c11 = 1374,                        /* -std=c11 */
  /* OPT_std_c1x = 1375, */                  /* -std=c1x */
  /* OPT_std_c89 = 1376, */                  /* -std=c89 */
  OPT_std_c90 = 1377,                        /* -std=c90 */
  OPT_std_c99 = 1378,                        /* -std=c99 */
  /* OPT_std_c9x = 1379, */                  /* -std=c9x */
  OPT_std_f2003 = 1380,                      /* -std=f2003 */
  OPT_std_f2008 = 1381,                      /* -std=f2008 */
  OPT_std_f2008ts = 1382,                    /* -std=f2008ts */
  OPT_std_f95 = 1383,                        /* -std=f95 */
  OPT_std_gnu = 1384,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1385, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1386, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1387,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1388,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1389, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1390, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1391,                    /* -std=gnu++1z */
  OPT_std_gnu__98 = 1392,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1393,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1394, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1395, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1396,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1397,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1398, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1399, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1400,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1401, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1402, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1403, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1404,                     /* -std=legacy */
  OPT_symbolic = 1405,                       /* -symbolic */
  OPT_t = 1406,                              /* -t */
  OPT_time = 1407,                           /* -time */
  OPT_time_ = 1408,                          /* -time= */
  OPT_traditional = 1409,                    /* -traditional */
  OPT_traditional_cpp = 1410,                /* -traditional-cpp */
  OPT_trigraphs = 1411,                      /* -trigraphs */
  OPT_u = 1412,                              /* -u */
  OPT_undef = 1413,                          /* -undef */
  OPT_v = 1414,                              /* -v */
  OPT_version = 1415,                        /* -version */
  OPT_w = 1416,                              /* -w */
  OPT_wrapper = 1417,                        /* -wrapper */
  OPT_x = 1418,                              /* -x */
  OPT_z = 1419,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
