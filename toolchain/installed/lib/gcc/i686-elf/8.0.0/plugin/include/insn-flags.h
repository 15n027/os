...
static inline rtx gen_save_multiplesi                            (rtx, rtx);
static inline rtx
gen_save_multiplesi(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_save_multipledi                            (rtx, rtx);
static inline rtx
gen_save_multipledi(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_restore_multiplesi                         (rtx, rtx);
static inline rtx
gen_restore_multiplesi(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_restore_multipledi                         (rtx, rtx);
static inline rtx
gen_restore_multipledi(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_restore_multiple_and_returnsi              (rtx, rtx);
static inline rtx
gen_restore_multiple_and_returnsi(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_restore_multiple_and_returndi              (rtx, rtx);
static inline rtx
gen_restore_multiple_and_returndi(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_restore_multiple_leave_returnsi            (rtx, rtx);
static inline rtx
gen_restore_multiple_leave_returnsi(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
static inline rtx gen_restore_multiple_leave_returndi            (rtx, rtx);
static inline rtx
gen_restore_multiple_leave_returndi(rtx ARG_UNUSED (a), rtx ARG_UNUSED (b))
{
  return 0;
}
